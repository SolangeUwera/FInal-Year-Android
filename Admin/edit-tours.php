            ...
            <form role="form" name="tour-edit" method="post" action="" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="package-duration" placeholder="Package Duration" name="package_duration" value="<?php echo empty($package_daysUpdated) ? $package_days : $package_daysUpdated ?>">
                </div>
                <div class="form-group">
                  <label>Price</label>
                  <input type="number" class="form-control" id="package-price" placeholder="Price" name="package_price" value="<?php echo empty($package_priceUpdated) ? $package_price : $package_priceUpdated ?>" required>
                </div>
                <div class="form-group">
                  <label>Seats</label>
                  <input type="number" class="form-control" id="package-seat" placeholder="Seats" name="package_seat" value="<?php echo empty($package_seatUpdated) ? $package_seat : $package_seatUpdated ?>" required>
                </div>
                <div class="form-group">
