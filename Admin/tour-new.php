...
if(isset($_POST['addTour']))
{
  ...
  $statement="insert into tours
  (title,price,days,location,description,image,capacity,addedBy)
   values ('$package_name','$package_price', '$package_duration', '$package_location', '$package_desc', '$target_file', '$package_seat', '$addedBy')";
        ...
        -------------------------->
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add New Tour</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" name="package-new" action="" method="post"  enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="package-duration" placeholder="Package Duration" name="package_duration" required>
                </div>
                <div class="form-group">
                  <label>Price</label>
                  <input type="number" class="form-control" id="package-price" placeholder="Price" name="package_price"required>
                </div>
                <div class="form-group">
                  <label>Seats</label>
                  <input type="number" class="form-control" id="package-seat" placeholder="Seats" name="package_seat" required>
                </div>  
              ...
              <div class="box-footer">
               ...
               <div class="error">
                ...
                <input type="submit" class="btn btn-primary" name="addTour" value="ADD NEW"/>
              </div>
            </form>
          </div>
