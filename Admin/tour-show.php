          ...
          <table class="table table-hover">
            ...
            if (mysqli_num_rows($result) > 0) {
              while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo ($row['status'] === 'canceled') || ($row['status'] === 'confirmed') ? "" : " <td><a href=\"cancel-tour.php?enquiry_id=$row[enquiry_id]\" onClick=\"return confirm('Are you sure you want to cancel?')\">Cancel</a> ";
                echo "</tr>";
              }
            } else {
