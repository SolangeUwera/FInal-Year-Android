                    ...
                    if($_SESSION["user_role"]=="Admin")
                    {
                      ...
                      if (mysqli_num_rows($result) > 0)
                      {
                          while($row = mysqli_fetch_assoc($result))
                          {
                            ...
                            echo "<td><a href=\"delete-hotels.php?hotel_id=$row[hotel_id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a> | <a href=\"edit-hotels.php?hotel_id=$row[hotel_id]\">Edit</a> </td>";
                            echo "</tr>";
                          }
                      }
                      else
