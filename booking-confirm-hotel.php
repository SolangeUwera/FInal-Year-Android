...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
	...
	if (mysqli_query($conn, $statement)) {
		...
		$message = 'Hello ' . $enq_hotel_name . ', you booked '
			. $hotel_title . 'with ' . $hotel_title . "- "
			. $room_title . ' Room and  you will have the room(s) from 
' . $enq_hotel_checkin . ' till this date ' . $enq_hotel_checkout . '
and amount to pay is  ' .  $_SESSION['c_symbol'] .  $price . ' per each room, You booked  
' . $enq_hotel_room . '  Rooms and Total Amount is  ' .
			($_SESSION['c_symbol'] . $enq_hotel_room * $price);
		$curl = curl_init();
		curl_setopt_array($curl, array(
			...
			CURLOPT_POSTFIELDS => array(
				'action' => 'send-sms',
				'to' => '+25' . $enq_hotel_phone, 'from' => 'Park Book', 'sms'
											...
											<div class="row">
												<form role="form" name="hotels-enq" method="post" action="">
													...
													<table class="table table-hover">
														...
														<tbody>
															<tr>
																<td class="col-md-9"><em><?php echo $hotel_title . "- " . $room_title ?></em></h4>
																</td>
															...
															<tr>
																...
																<td class="text-center text-danger">
																	<h4><strong><?php echo $_SESSION['c_symbol'] . $enq_hotel_room * $price; ?></strong></h4>
																</td>
															</tr>
														</tbody>
													</table>
